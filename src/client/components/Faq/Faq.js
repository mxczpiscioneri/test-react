            ...
            <Col xs={12} sm={10} offset={{ sm: 1 }}>
              <Accordion>
                <AccordionItem title={'DÚVIDAS SOBRE O CONSÓRCIO'}>
                  <div>
                    <p className={"question"}>O que é consórcio?</p>
                    ...
                    <p className={"question"}>Qual o papel da Administradora de consórcios?</p>
                    ...
                    <p className={"question"}>O que é grupo e cota?</p>
                    ...
                    <p className={"question"}>Quem é responsável pela regulamentação/fiscalização dos Consórcios?</p>
                    ...
                    <p className={"question"}>Como é composta a prestação de consórcio?</p>
                    ...
                    <p className={"question"}>O que é Taxa de Administração?</p>
                    ...
                    <p className={"question"}>O que é Fundo Comum?</p>
                    ...
                    <p className={"question"}>O que é Fundo de Reserva?</p>
                    ...
                    <p className={"question"}>O que é Seguro de Quebra de Garantia?</p>
                    ...
                    <p className={"question"}>O que é Seguro Prestamista?</p>
                    ...
                    <p className={"question"}>O que é assembleia Geral Ordinária?</p>
                ...
                <AccordionItem title={'CONTRATAÇÃO / ADESÃO DE GRUPOS'}>
                  <div>
                    <p className={"question"}>Existe uma quantidade mínima de pessoas para a inauguração do Grupo?</p>
                    ...
                    <p className={"question"}>Como receberei informações sobre meu plano de consórcio?</p>
                ...
                <AccordionItem title={'CONTEMPLAÇÃO / UTILIZAÇÃO DO CRÉDITO'}>
                  <div>
                    ...
                    <p className={"question"}>Quantos bens serão entregues em cada assembleia?</p>
                    ...
                    <p className={"question"}>Se eu quitar a cota eu sou contemplado?</p>
                    <p className={"answer"}>A quitação da cota não garante a contemplação. A contemplação é por lance ou sorteio.</p>

                    <p className={"question"}>Como funciona a apuração do sorteio pela loteria federal?</p>
                    ...
                    <p className={"question"}>Se estiver em atraso, participo dos sorteios e/ou posso ofertar lance?</p>
                    ...
                    <p className={"question"}>Como faço para ofertar um lance?</p>
                    ...
                    <p className={"question"}>Qual o percentual mínimo e máximo para lances?</p>
                    ...
                    <p className={"question"}>Como funciona a apuração do lance vencedor?</p>
                    ...
                    <p className={"question"}>Quais as formas de ofertar um lance?</p>
                    ...
                    <p className={"question"}>Onde consigo ver o resultado da última assembleia do meu grupo?</p>
                    ...
                    <p className={"question"}>Como devo proceder após a contemplação?</p>
                    ...
                    <p className={"question"}>Se eu ofertar um lance e não for contemplado tenho que pagá-lo mesmo assim?</p>
                    ...
                    <p className={"question"}>Sendo contemplado, de que forma efetuo o pagamento do lance?</p>
                    ...
                    <p className={"question"}>De que forma o lance pago é amortizado no saldo devedor da cota?</p>
                    ...
                    <p className={"question"}>Há um prazo definido para utilização da carta de crédito, após a contemplação?</p>
                    ...
                    <p className={"question"}>Depois da contemplação, em quanto tempo ocorre a liberação ao vendedor?</p>
                    ...
                    <p className={"question"}>Possuo um consórcio contemplado, utilizei a carta e sobrou um saldo, este valor é reembolsado somente após a quitação da carta?</p>
                    ...
                    <p className={"question"}>Quais os bens que posso comprar após a contemplação?</p>
                    ...
                    <p className={"question"}>Posso retirar o meu crédito em espécie?</p>
                    ...
                    <p className={"question"}>Tenho duas cotas, fui contemplado (a) em uma. Posso faturar um bem e utilizar as duas cotas?</p>
                    ...
                    <p className={"question"}>Fui contemplado (a) posso adquirir 2 bens com o crédito que possuo?</p>
                    <p className={"answer"}>Sim, se houver necessidade de pagar a diferença poderá ser feito com recursos próprios.</p>

                    <p className={"question"}>Possuo um CDC ativo. Pposso utilizar carta do consórcio para liquidar este bem?</p>
                    ...
                    <p className={"question"}>Possuo um leasing ativo, posso utilizar carta do consórcio para liquidar este bem ?</p>
                    <p className={"answer"}>Não, apenas para quitação de financiamento.</p>
                  </div>
                </AccordionItem>
                <AccordionItem title={'MANUTENÇÃO DA COTA'}>
                  <div>
                    <p className={"question"}>Qual impacto se houver atraso no pagamento das parcelas?</p>
                    ...
                    <p className={"question"}>É permitido realizar uma antecipação do pagamento de prestações?</p>
                    ...
                    <p className={"question"}>Sou funcionário do Grupo e pago um percentual menor de taxa de administração, em caso de desligamento, a taxa reduzida será mantida?</p>
                    <p className={"answer"}>Sim, a condição será mantida.</p>

                    <p className={"question"}>Fui contemplado, já estou de posse do bem, mas gostaria de trocá-lo, é possível?</p>
                    ...
                    <p className={"question"}>É possível a transferência da cota?</p>
                    ...
                    <p className={"question"}>Como ocorre o reajuste de preço do crédito/parcelas?</p>
                    <p className={"answer"}>No caso de veículos, o reajuste pode ser mensal se houver alteração na tabela da montadora.</p>

                    <p className={"question"}>Em caso de falecimento, o seguro que contratei no ato da adesão quita o saldo devedor da minha cota?</p>
                ...
                <AccordionItem title={'ENCERRAMENTO DO GRUPO'}>
                  <div>
                    <p className={"question"}>O que é consorciado excluído?</p>
                    ...
                    <p className={"question"}>Adquiri uma cota e desisti de pagar, em qual momento serei restituído dos valores que paguei?</p>
                    ...
                    <p className={"question"}>Qual a multa aplicada para os casos de desistência/inadimplência?</p>
                    ...
                    <p className={"question"}>Como é feita o pagamento do saldo remanescente no grupo aos consorciados?</p>
